...
public class Bed extends Furniture {
	...
	public Bed(double length , double width, double height) {
	...
	public Bed(double length , double width, double height,Style archStyle) {
		super(archStyle);
		this.length = length;
		this.width = width;
		this.height = height;
	...
	private double COST = 50.00, length, width, height;
